...
const Sessions = ({ children }: { children: JSX.Element }) => {
    ...
    const addSession = () => {
        ...
        if (sessions) {
            ...
            localStorage.setItem('sessions', JSON.stringify([session, ...paredSessions]));
        }
        else
        ...
        <Drawer>
            ...
            <DrawerContent className="bg-gray-200 dark:bg-gray-900">
                <DrawerHeader >
                    ...
                    <DrawerDescription className="text-center">Session helps you to organise your codes.</DrawerDescription>
                </DrawerHeader>
                                    ...
                                    <PopoverContent>
                                        <div className="mb-4">
                                            ...
                                            <div className="flex w-full max-w-sm items-center space-x-2">
                                                <Input onChange={(e) => setSessionName(e.target.value)} type="text" placeholder="Session Name" />
                                                <Button onClick={addSession} type="submit">Create</Button>
                                            </div>
                                        </div>
                                    </PopoverContent>
                                </Popover>
